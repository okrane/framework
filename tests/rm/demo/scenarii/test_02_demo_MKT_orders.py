def test():
    ...
    stock_FTE = OrdersReader({'name'                   : 'stock_FTE'},
                             ...
                             {'start_time'             : '07:00:00:000',
                              ...
                              'log_filename'           : path + '/dev/tests/demo/log/test_02_demo_MKT_orders.log', 
                              'orders_filename'        : path + '/dev/tests/demo/scenarii/test_02_demo_MKT_orders.txt',
                              'print'                  : True},
                             trace)
    ...
    # Return results.                                   #
    # ------------------------------------------------- #
    assert( filecmp.cmp(path + '/dev/tests/demo/log/test_02_demo_MKT_orders.log',path + '/dev/tests/demo/log/test_02_demo_MKT_orders.ref'))
    # ------------------------------------------------- #
