def test():
    ...
    stock_FTE = OrdersReader({'name'                   : 'stock_FTE'},
                             ...
                             {'start_time'             : '07:00:00:000',
                              ...
                              'log_filename'           : path + '/dev/tests/demo/log/test_03_demo_M2L_orders.log', 
                              'orders_filename'        : path + '/dev/tests/demo/scenarii/test_03_demo_M2L_orders.txt',
                              'print'                  : True},
                             trace)
    ...
    # Return results.                                   #
    # ------------------------------------------------- #
    assert( filecmp.cmp(path + '/dev/tests/demo/log/test_03_demo_M2L_orders.log',path + '/dev/tests/demo/log/test_03_demo_M2L_orders.ref'))
    # ------------------------------------------------- #
