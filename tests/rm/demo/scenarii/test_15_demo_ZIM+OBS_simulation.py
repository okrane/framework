def test():
    ...
    # ------------------------------------------------- #
    file = open('C:/st_sim/dev/tests/demo/log/test_15_demo_ZIM+OBS_simulation.log', 'w')
    # ------------------------------------------------- #
    ...
    # Return results.                                   #
    # ------------------------------------------------- #
    assert( filecmp.cmp(path + '/dev/tests/demo/log/test_15_demo_ZIM+OBS_simulation.log',path + '/dev/tests/demo/log/test_15_demo_ZIM+OBS_simulation.ref'))
    # ------------------------------------------------- #
