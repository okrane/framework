...
# ------------------------------------------------- #
sched.addOrderBook('normal', 'ALUA.PA')
stock_ALUA_PA_4 = SBBModel({'login'                  : 'a_lambda_guy', 
                            'name'                   : 'stock_ALUA_PA_4', 
                            'engine_type'            : 'normal'},
                           ...
                           {'number_of_bt'           : 10, 
                            ...
                            'seed'                   : 4},
                           trace)
sched.addAgent(stock_ALUA_PA_4)
# ------------------------------------------------- #
...
#                 Create traders                    #
# ------------------------------------------------- #
TvfoTriggeredIs000_ALUA_PA_4 = TvfoTriggeredIs({'class_name'             : 'TvfoTriggeredIs', 
                                                'counter'                : 0, 
                                               ...
                                               {'tactic_max_lifetime'    : '00:10:00:000000', 
                                                ...
                                                'side'                   : 0},
                                               trace)
sched.addAgent(TvfoTriggeredIs000_ALUA_PA_4)
# ------------------------------------------------- #
...
#                  Return Results                   #
# ------------------------------------------------- #
TvfoTriggeredIs000_ALUA_PA_4.results()
# ------------------------------------------------- #
...
#                   Write Results                   #
# ------------------------------------------------- #
TvfoTriggeredIs000_ALUA_PA_4.write_mat_file('C:/st_repository/simep_scenarii/results/SBB/TvfoTriggeredIs/ALUA_PA_004/DAY_20100218/b05c7b7c0d4d99d9819a00e3fcfac272.mat')
# ------------------------------------------------- #
...
#                  Destroy objects                  #
# ------------------------------------------------- #
del(TvfoTriggeredIs000_ALUA_PA_4)
del(stock_ALUA_PA_4)
