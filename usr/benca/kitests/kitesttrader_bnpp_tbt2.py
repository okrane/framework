...
from simep.agents.kitesttrader import *
...
# ------------------------------------------------- #
AnalyticsManager.new_bus({'data_type'               : 'TBT2', 
                          'opening'                 : {4: '07:00:00:000'}, 
                          'input_file_names'        : {4: 'Y:/tick_ged'}, 
                          'trading_destination_names' : ['ENPA'], 
                          'date'                    : '20100520', 
...
#                 Create traders                    #
# ------------------------------------------------- #
KiTestObs000=KiTestTrader({'class_name'              : 'KiTestTrader', 
                            'counter'                 : 0, 
                            'name'                    : 'KiTestObs000'},
                           {'trading_destination_ids' : [4], 
                            'date'                    : '20100520', 
                           ...
                           {'log_filename'            : 'C:/kitesttrader_bnpp_tbt2.log'},
                           trace)
