...
from simep.bin.simepcore import Scheduler, PyAgent, Order
...
class MfgZero(BaseAgent):
    ...
    def _createOrder(self, prefix, side, price, type, qty, execType):
        ...
        self.nbOrders += 1
        order.orderId = "%s$%i" % (prefix, self.nbOrders)
...
sched.addOrderBook('normal', 'MFGEN')    

agent = MfgZero({'name':'mfgen001'}, {'ric':'MFGEN'}, {}, sched.getTrace())
