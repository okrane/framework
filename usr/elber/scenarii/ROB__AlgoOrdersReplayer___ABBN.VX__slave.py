...
AlgoOrdersReplayer000_ABBN_VX = AlgoOrdersReplayer({'class_name'              : 'AlgoOrdersReplayer', 
                                                   ...
                                                   {'trading_destination_ids' : [18], 
                                                    ...
                                                    'trading_destination_names' : ['VIRTX'], 
                                                    'ric'                     : 'ABBN.VX', 
                                                    'output_filename'         : 'C:/st_sim/usr/dev/elber/scenarii/ROB/AlgoOrdersReplayer/ABBN_VX_018/DAY_20100823/f245028930812d2fca60b6adb8056e6e'},
                                                   {'delta_t'                 : '00:00:01:000', 
                                                    'loading_method'          : 'headed_text_file', 
                                                    'cmd_filename'            : 'C:/st_sim/usr/dev/elber/data/detail_occ_3_Jn}0026.txt', 
...
#                   Write Results                   #
# ------------------------------------------------- #
AlgoOrdersReplayer000_ABBN_VX.write_mat_file('C:/st_sim/usr/dev/elber/scenarii/ROB/AlgoOrdersReplayer/ABBN_VX_018/DAY_20100823/f245028930812d2fca60b6adb8056e6e.mat')
ScenarioDict.insertScenarioParameters(702, 'AlgoOrdersReplayer', 'C:/st_sim/usr/dev/elber/scenarii/ROB/AlgoOrdersReplayer/ABBN_VX_018/DAY_20100823/f245028930812d2fca60b6adb8056e6e.mat', 'ABBN.VX', 80940, [18], '20100823', 'ROBModel', "{'delta_t': '00:00:01:000', 'loading_method': 'headed_text_file', 'cmd_filename': 'C:/st_sim/usr/dev/elber/data/detail_occ_3_Jn}0026.txt', 'observer_class': 'OrdersReplayerObserver', 'observer_module': 'simep.subagents.orders_replayer_observer'}")
# ------------------------------------------------- #
