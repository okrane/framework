...
from usr.dev.exemple.agents.Trader import *
...
#                 Create traders                    #
# ------------------------------------------------- #
Trader000_FTE_PA = Trader({'class_name'                     : 'Trader', 
                           'counter'                        : 0, 
                           'name'                           : 'Trader000'},
                          {'venue_ids'                      : {4: '4#FR0000133308'}, 
                           'trading_venue_ids'              : [4], 
                           ...
                           'trading_venue_types'            : {4: 'L'}, 
                           'closings'                       : {4: '15:30:00:000'}, 
                           'output_filename'                : 'C:/st_sim2.5/usr/dev/exemple/scenarii/ROB/Trader/FTE_PA_004/DAY_20111101/7ef605fc8dba5425d6965fbd4c8fbe1f', 
                          ...
                          {'dt'                             : 15, 
                           'd'                              : 0},
                          trace)
sched.addAgent(Trader000_FTE_PA)
# ------------------------------------------------- #
...
# ------------------------------------------------- #
if __release__:
    Trader000_FTE_PA.write_mat_file('C:/st_sim2.5/usr/dev/exemple/scenarii/ROB/Trader/FTE_PA_004/DAY_20111101/7ef605fc8dba5425d6965fbd4c8fbe1f.mat')
    ScenarioDict.insertScenarioParameters(44, 'Trader', 'C:/st_sim2.5/usr/dev/exemple/scenarii/ROB/Trader/FTE_PA_004/DAY_20111101/7ef605fc8dba5425d6965fbd4c8fbe1f.mat', 'FTE.PA', 110, [4], '20111101', 'ROBModel', "{'dt': 15, 'd': 0}")
    Trader000_FTE_PA.write_csv_file('C:/st_sim2.5/usr/dev/exemple/scenarii/ROB/Trader/FTE_PA_004/DAY_20111101/7ef605fc8dba5425d6965fbd4c8fbe1f.csv')
# ------------------------------------------------- #
